...
CREATE TABLE `_regions` (
  ...
  PRIMARY KEY (`id`),
  KEY `title` (`title`),
  KEY `fk_countries_id` (`country_id`),
  CONSTRAINT `fk_countries_id` FOREIGN KEY (`country_id`) REFERENCES `_countries` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2019-01-24  0:04:15
